...
@log_streamlit_component('admin_users_main')
def main():
    """Función principal para la página de administración de usuarios.
    """
...
if __name__ == "__main__":
    try:
        ...
        logger.error(f"Error crítico en Administración de Usuarios: {e}", exc_info=True)
